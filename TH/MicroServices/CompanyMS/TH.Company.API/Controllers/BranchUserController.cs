...
public class BranchUserController : CustomBaseController
{
    ...
    public BranchUserController(IBranchUserService branchUserService, IMapper mapper, IServiceScopeFactory scopeFactory, HttpContextAccessor httpContextAccessor) : base(httpContextAccessor)
    {
