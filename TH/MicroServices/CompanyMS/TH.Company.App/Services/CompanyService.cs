...
public partial class CompanyService : BaseService, ICompanyService
{
    ...
    public CompanyService(IUow repo, IPublishEndpoint publishEndpoint, IMapper mapper, IConfiguration config, IBranchUserService branchUserService,
        IBranchService branchService, IPermissionService permissionService, IRoleService roleService, IUserCompanyService userCompanyService,
        IUserRoleService userRoleService, IUserService userService) : base(mapper, publishEndpoint, config)
    {
