...
public partial class UserRoleService : BaseService, IUserRoleService
{
    ...
    public UserRoleService(IUow repo) : base()
    {
    ...
    public async Task<UserRole> SaveAsync(UserRole entity, DataFilter dataFilter, bool commit = true)
    {
        ...
        await Repo.UserRoleRepo.SaveAsync(entity);
    ...
    public async Task<UserRole> UpdateAsync(UserRole entity, DataFilter dataFilter, bool commit = true)
    {
        if (entity == null) throw new ArgumentNullException(nameof(entity));

        var existingEntity = await Repo.UserRoleRepo.SingleOrDefaultQueryableAsync(x => (x.SpaceId.Equals(entity.SpaceId)) && (x.CompanyId.Equals(entity.CompanyId)) && (x.Id.Equals(entity.Id)));
    ...
    public async Task<bool> SoftDeleteAsync(UserRole entity, DataFilter dataFilter, bool commit = true)
    {
        if (entity == null) throw new ArgumentNullException(nameof(entity));
    ...
    public async Task<bool> DeleteAsync(UserRole entity, DataFilter dataFilter, bool commit = true)
    {
        if (entity == null) throw new ArgumentNullException(nameof(entity));
        ...
        Repo.UserRoleRepo.Delete(existingEntity);
    ...
    public async Task<UserRole> FindAsync(UserRoleFilterModel filter, DataFilter dataFilter)
    {
        try
        {
            if (filter == null) throw new ArgumentNullException(nameof(filter));

            var entity = await Repo.UserRoleRepo.SingleOrDefaultQueryableAsync(x => (x.SpaceId.Equals(filter.SpaceId)) && (x.CompanyId.Equals(filter.CompanyId)) && (x.Id.Equals(filter.Id)));
    ...
    public async Task<IEnumerable<UserRole>> GetAsync(UserRoleFilterModel filter, DataFilter dataFilter)
    {
        try
        {
            if (filter == null) throw new ArgumentNullException(nameof(filter));
            ...
            var includePredicates = new List<Expression<Func<UserRole, object>>>();
            ...
            var pagedList = await Repo.UserRoleRepo.GetFilterableAsync(predicates, includePredicates, filter.SortFilters, filter.PageIndex, filter.PageSize, dataFilter);
    ...
    private void ApplyValidationBl(UserRole entity, bool skip = false)
    {
        try
        {
            if (entity == null) throw new ArgumentNullException(nameof(entity));
    ...
    private async Task ApplyDuplicateOnSaveBl(UserRole entity, DataFilter dataFilter)
    {
        try
        {
            if (entity == null) throw new ArgumentNullException(nameof(entity));
    ...
    private async Task ApplyDuplicateOnUpdateBl(UserRole entity, DataFilter dataFilter)
    {
        try
        {
            if (entity == null) throw new ArgumentNullException(nameof(entity));
