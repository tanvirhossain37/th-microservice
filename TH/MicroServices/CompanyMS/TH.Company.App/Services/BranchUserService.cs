...
public partial class BranchUserService : BaseService, IBranchUserService
{
    ...
    public BranchUserService(IUow repo, IPublishEndpoint publishEndpoint, IMapper mapper, IConfiguration config) : base(mapper, publishEndpoint, config)
    {
    ...
    public async Task<BranchUser> UpdateAsync(BranchUser entity, DataFilter dataFilter, bool commit = true)
    {
        ...
        var existingEntity = await Repo.BranchUserRepo.FindByIdAsync(entity.Id, dataFilter);
    ...
    public async Task<bool> SoftDeleteAsync(BranchUser entity, DataFilter dataFilter, bool commit = true)
    {
        if (entity == null) throw new ArgumentNullException(nameof(entity));
    ...
    public async Task<bool> DeleteAsync(BranchUser entity, DataFilter dataFilter, bool commit = true)
    {
        if (entity == null) throw new ArgumentNullException(nameof(entity));
    ...
    public async Task<BranchUser> FindByIdAsync(BranchUserFilterModel filter, DataFilter dataFilter)
    {
        try
        {
            ...
            var entity = await Repo.BranchUserRepo.FindByIdAsync(filter.Id, dataFilter);
    ...
    private void ApplyValidationBl(BranchUser entity)
    {
        try
        {
            if (entity == null) throw new ArgumentNullException(nameof(entity));
    ...
    private async Task ApplyDuplicateOnSaveBl(BranchUser entity, DataFilter dataFilter)
    {
        try
        {
            if (entity == null) throw new ArgumentNullException(nameof(entity));
    ...
    private async Task ApplyDuplicateOnUpdateBl(BranchUser entity, DataFilter dataFilter)
    {
        try
        {
            if (entity == null) throw new ArgumentNullException(nameof(entity));
