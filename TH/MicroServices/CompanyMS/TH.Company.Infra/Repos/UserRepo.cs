...
public partial class UserRepo : RepoSQL<User>, IUserRepo
{
    ...
    public async Task<User> FindByNameAsync(string spaceId, string companyId, string userName, DataFilter dataFilter)
    {
    ...
    public async Task<User> FindByNameExceptMeAsync(string id, string spaceId, string companyId, string userName, DataFilter dataFilter)
    {
